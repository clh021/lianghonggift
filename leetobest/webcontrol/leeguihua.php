	...
	*/
	...
	if($method=='del'){
		...
		*/
		...
		$arr3=$arr['tguihua'][1];
		array_shift($arr3);
		$arr1=array($shixian,$title,$banfa,$place,$xiezhu,$zhongyao,$jinji,$tiaojian,$beizhu,$zongjie,$zongjietime,$addren,$nowtime,$nowtime);
		...
		if($flag){
			...
			if($succ!==false){
				msg_out('恭喜！添加成功！',URL_PATH.'web/main/guihua.php');
			}else{
				msg_back('糟糕，插入数据库失败。');
			}
		}
