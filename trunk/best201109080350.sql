...
Source Database       : best

Target Server Type    : MYSQL
Target Server Version : 50091
File Encoding         : 65001

Date: 2011-09-08 03:50:58
*/
...
-- ----------------------------
DROP TABLE IF EXISTS `think_groups`;
...
CREATE TABLE `think_task` (
  ...
  `timeunite` varchar(45) NOT NULL default '',
  `min` int(10) unsigned NOT NULL default '0',
  `max` int(10) unsigned NOT NULL default '0',
  `lasttime` int(10) unsigned NOT NULL default '0',
  `lastnum` int(10) unsigned NOT NULL default '0',
  `calculway` int(10) unsigned NOT NULL default '1',
  `nexttime` int(10) unsigned NOT NULL default '0',
  `calculnum` int(10) unsigned NOT NULL default '1',
  `taskunite` varchar(45) NOT NULL default '',
  PRIMARY KEY  (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of think_task
-- ----------------------------
INSERT INTO think_task VALUES ('1', '做俯卧撑', '俯卧撑', '20', 'day', '5', '30', '0', '0', '1', '0', '1', '个');
...
-- ----------------------------
INSERT INTO think_user VALUES ('1', 'admin', '管理员', '21232f297a57a5a743894a0e4a801fc3', '', '1315317330', '127.0.0.1', '889', '8888', 'liu21st@gmail.com', '备注信息', '1222907803', '1239977420', '1', '0', '');
