...
function getuserStatus($status, $imageShow = true) {
	switch ($status) {
		...
		case 3 :
			$showText = '认证通过';
			$showImg = '<IMG SRC="' . WEB_PUBLIC_PATH . '/Images/ok.gif" WIDTH="20" HEIGHT="20" BORDER="0" ALT="认证通过">';
			break;
		case 4 :
			$showText = '认证未通过';
			$showImg = '<IMG SRC="' . WEB_PUBLIC_PATH . '/Images/del.gif" WIDTH="20" HEIGHT="20" BORDER="0" ALT="认证未通过">';
			break;
		case 5 :
			$showText = '禁用';
			$showImg = '<IMG SRC="' . WEB_PUBLIC_PATH . '/Images/del.gif" WIDTH="20" HEIGHT="20" BORDER="0" ALT="禁用">';
			break;
		default :
		case 1 :
			$showText = '未认证';
			$showImg = '<IMG SRC="' . WEB_PUBLIC_PATH . '/Images/limit.gif" WIDTH="20" HEIGHT="20" BORDER="0" ALT="未认证">';
...
function showuserStatus($status, $id) {
	switch ($status) {
		case 1 :
		case 2 :
		case 3 :
		case 4 :
			$info = '<a href="javascript:setUserStatus(5,' . $id . ')">禁用</a>';
			break;
		case 5 :
			$info = '<a href="javascript:setUserStatus(1,' . $id . ')">启用</a>';
			break;
		default:
			$info = '<a href="javascript:setUserStatus(1,' . $id . ')">恢复</a>';
	}
	return $info;
}
